  ...
  try {
    ...
    if (membership) {
      ...
      document.getElementById("membership-type-value").textContent =
        membership.type;
      document.getElementById("membership-since-value").textContent =
        membership.startDate;
      document.getElementById("membership-expires-value").textContent =
        membership.expiryDate;
      document.getElementById("membership-id-value").textContent =
        membership.id;
      document.getElementById("billing-cycle-value").textContent =
        membership.billingCycle;
      document.getElementById("next-billing-value").textContent =
    ...
    showNotification(
      "ไม่สามารถโหลดข้อมูลสมาชิกได้ กรุณาลองใหม่อีกครั้ง",
      "error"
    );
  }
}
